  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src={assets.Aweb} alt="" className="w-full rounded-3xl" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        >
          <p className="mb-10 max-w-2xl  font-Ovo">
            Passionate software engineer with a strong foundation in backend and
            frontend development. I build scalable, efficient systems with a
            practical problem-solving mindset and care about clear, modern user
            experiences. My focus is on shipping reliable products that are
            useful, maintainable, and ready to grow.
          </p>
